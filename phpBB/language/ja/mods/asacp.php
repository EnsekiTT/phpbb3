...
$lang = array_merge($lang, array(
	...
	'ASACP_AKISMET_SUBMIT'	=> 'Akismetにスパムと判断されたメッセージを送信する',
	'ASACP_BAN'				=> 'ワンクリック禁止設定',
	'ASACP_BAN_ACTIONS'		=> '次のアクションが実行されます: %s',
	'ASACP_BAN_COMPLETE'	=> '禁止ユーザの設定に成功しました.<br /><br /><a href="%s">ここをクリックするとユーザのプロフィールページに戻ります。</a>',
	'ASACP_BAN_CONFIRM'		=> 'ユーザ「%s」を禁止ユーザに設定してもよろしいですか？ <strong class="error">これは、元に戻すことは出来ません</strong>',
	'ASACP_BAN_REASON'		=> '禁止理由',
	'ASACP_BAN_REASON_EXPLAIN'	=> '禁止理由を入力してください（非公開）',
	'ASACP_BAN_REASON_SHOWN_TO_USER'			=> '禁止理由をユーザに開示する',
	'ASACP_BAN_REASON_SHOWN_TO_USER_EXPLAIN'	=> 'ここに入力したメッセージは、禁止されたユーザに表示されます。',
	...
	'SPAM_DENIED'			=> 'このメッセージは、スパムとして判断されたために拒否されました。',
