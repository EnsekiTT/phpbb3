...
$lang = array_merge($lang, array(
	...
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> '“いいえ” にした場合、掲示板全体に亘って機能は無効化されます。“はい” にした場合、機能の 有効/無効 はフォーラム個々の設定に依存します。',
...
$lang = array_merge($lang, array(
	...
	'MAX_GUEST_POST_URLS'					=> 'ゲスト投稿のリンクの最大数',
	'MAX_GUEST_POST_URLS_EXPLAIN'			=> 'ゲストが投稿する記事で使用可能なハイパーリンクの数の上限です。0 に設定すると上限はありません。',
