...
$lang = array_merge($lang, array(
  ...
  'FORUM_GUIDE'     => 'フォーラムの利用について',
	...
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'パスワードが正しくありません。もしくは、phpBB2 から phpBB3 へのデータコンバート時にあなたの旧パスワードを新しい暗号化方式に変換する事ができなかった可能性があります。%s新しいパスワードを要求%sしてください。 問題が解決しない場合、%s管理人%sにご連絡ください。',
	...
	'TOTAL_POSTS'		=> '投稿数',
	'TOTAL_POSTS_OTHER'	=> '投稿数: <strong>%d</strong>',
	...
	'tz_zones'	=> array(
		...
		'-2'	=> '[UTC - 2] フェルナンド・ド・ノローニャ島時刻、サウスジョージア島＆サウスサンドイッチ諸島時刻',
